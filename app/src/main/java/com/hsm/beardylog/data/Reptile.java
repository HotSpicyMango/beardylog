...
public class Reptile {
    ...
    public Reptile(long id, String name, String species, String morph, long referenceDate, String referenceDateType, @Nullable String photoUri, long createdAt) {
        this.id = id; this.name = name; this.species = species; this.morph = morph;
